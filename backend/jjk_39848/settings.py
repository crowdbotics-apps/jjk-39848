"""
Django settings for jjk_39848 project.
...
WSGI_APPLICATION = 'jjk_39848.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "jjk_39848 API",
    "DESCRIPTION": "API documentation for jjk_39848 App",
    "VERSION": "v1",
}
